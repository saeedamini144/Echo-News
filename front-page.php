...
<section class="echo-trending-area">
    <div class="echo-trending-content">
        <div class="container">
            ...
            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_third_section_settings', 'h2')) ?> class="third-title-tag-style">
                <?php echo esc_html(get_theme_mod('title_main_page_third_section_settings', 'Title')) ?>
            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_third_section_settings', 'h2')) ?>>
            <!-- must add the default tag to show correct style in first watch -->
    ...
    <div class="echo-video-content">
        <div class="container">
            <div class="echo-video-area-title-row text-center">
                ...
                <<?php echo esc_html(get_theme_mod('tag_heading_main_page_fourth_section_settings', 'h2')) ?> class="fourth-title-tag-style">
                    <?php echo esc_html(get_theme_mod('title_main_page_fourth_section_settings', 'Title')) ?>
                </<?php echo esc_html(get_theme_mod('tag_heading_main_page_fourth_section_settings', 'h2')) ?>>
                <!-- must add the default tag to show correct style in first watch -->
            </div>
        ...
        <div class="container">
            <div class="echo-de-category-full-content">
                <div class="echo-de-category-title-btn">
                    ...
                    <<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_settings', 'h2')) ?> class="fifth-title-tag-style">
                        <?php echo esc_html(get_theme_mod('title_main_page_fifth_section_settings', 'Title')) ?>
                    </<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_settings', 'h2')) ?>>
                    <!-- must add the default tag to show correct style in first watch -->
                    <a href="<?php echo esc_html(get_theme_mod('fifth_section_button_link_settings')) ?>" class="text-capitalize echo-py-btn"><?php echo esc_html(get_theme_mod('fifth_section_button_content_settings')) ?></a>
                </div>
                <div class="row gx-5">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="echo-de-category-content echo-responsive-wd">
                            <!-- change the title of the Fifth section col one -->
                            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col1_settings', 'h2')) ?> class="fifth-title-tag-style-col1">
                                <?php echo esc_html(get_theme_mod('title_main_page_fifth_section_col1_settings', 'Title')) ?>
                            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col1_settings', 'h2')) ?>>
                            <hr>
                            ...
                            <div class="echo-de-category-show-more-btn" wp-no-export>
                                <a href="<?php echo esc_html(get_theme_mod('fifth_section_col_one_button_link_settings')) ?>" class="text-capitalize echo-py-btn"><?php echo esc_html(get_theme_mod('fifth_section_col_one_button_content_settings')) ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="echo-de-category-content">
                            ...
                            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col2_settings', 'h2')) ?> class="fifth-title-tag-style-col2">
                                <?php echo esc_html(get_theme_mod('title_main_page_fifth_section_col2_settings', 'Title')) ?>
                            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col2_settings', 'h2')) ?>>
                            <hr>
                            <!-- call back the horizontal normal post card first column -->
                            <?php get_template_part('template-parts/horizontal-normal-posts-callback-col2') ?>
                            <div class="echo-de-category-show-more-btn">
                                <a href="<?php echo esc_html(get_theme_mod('fifth_section_col_two_button_link_settings')) ?>" class="text-capitalize echo-py-btn"><?php echo esc_html(get_theme_mod('fifth_section_col_two_button_content_settings')) ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="echo-de-category-content">
                            ...
                            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col3_settings', 'h2')) ?> class="fifth-title-tag-style-col3">
                                <?php echo esc_html(get_theme_mod('title_main_page_fifth_section_col3_settings', 'Title')) ?>
                            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_fifth_section_col3_settings', 'h2')) ?>>
                            <hr>
                            <!-- call back the horizontal normal post card first column -->
                            <?php get_template_part('template-parts/horizontal-normal-posts-callback-col3') ?>
                            <div class="echo-de-category-show-more-btn">
                                <a href="<?php echo esc_html(get_theme_mod('fifth_section_col_Three_button_link_settings')) ?>" class="text-capitalize echo-py-btn"><?php echo esc_html(get_theme_mod('fifth_section_col_Three_button_content_settings')) ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gx-6">
                    <div class="col-xl-8 col-lg-7 col-md-12">
                        <div class="echo-feature-area-site-title">
                            ...
                            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_settings', 'h2')) ?> class="sixth-title-tag-style">
                                <?php echo esc_html(get_theme_mod('title_main_page_sixth_section_settings', 'Title')) ?>
                            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_settings', 'h2')) ?>>
                            <!-- must add the default tag to show correct style in first watch -->
                            <div class="row gx-5">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12">
                        <div class="echo-feature-area-right-site-flexing">
                            <div class="echo-feature-area-right-site-follower">
                                ...
                                <<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col1_settings', 'h2')) ?> class="sixth-title-tag-style-col1">
                                    <?php echo esc_html(get_theme_mod('title_main_page_sixth_col1_section_settings', 'Follow Us')) ?>
                                </<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col1_settings', 'h2')) ?>>
                            ...
                            <div class="echo-feature-area-right-site-full-content">
                                <div class="echo-feature-area-right-site-audio-title">
                                    ...
                                    <<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col2_settings', 'h2')) ?> class="sixth-title-tag-style-col2">
                                        <?php echo esc_html(get_theme_mod('title_main_page_sixth_col2_section_settings', 'title')) ?>
                                    </<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col2_settings', 'h2')) ?>>
                                </div>
                            ...
                            <div class="echo-feature-area-right-site-newsletter">
                                <div class="echo-feature-area-rigth-site-newsletter-title">
                                    ...
                                    <<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col3_settings', 'h2')) ?> class="sixth-title-tag-style-col3">
                                        <?php echo esc_html(get_theme_mod('title_main_page_sixth_col3_section_settings', 'title')) ?>
                                    </<?php echo esc_html(get_theme_mod('tag_heading_main_page_sixth_section_col3_settings', 'h2')) ?>>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="echo-popular-area-title">
                            ...
                            <<?php echo esc_html(get_theme_mod('tag_heading_main_page_seventh_section_settings', 'h2')) ?> class="text-center seventh-title-tag-style">
                                <?php echo esc_html(get_theme_mod('title_main_page_seventh_section_settings', 'Title')) ?>
                            </<?php echo esc_html(get_theme_mod('tag_heading_main_page_seventh_section_settings', 'h2')) ?>>
                        </div>
                    </div>
                </div>
                <div class="row gx-5">
